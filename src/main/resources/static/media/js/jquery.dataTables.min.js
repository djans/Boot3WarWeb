...
(function(f){"function"===typeof define&&define.amd?define(["src/main/webapp/WEB-INF/view/media/js/jquery"],function(y){return f(y,window,document)}):"object"===typeof exports?module.exports=function(y, w){y||(y=window);w||(w="undefined"!==typeof window?require("src/main/webapp/WEB-INF/view/media/js/jquery"):require("src/main/webapp/WEB-INF/view/media/js/jquery")(y));return f(w,y,y.document)}:f(jQuery,window,document)})(function(f, y, w, n){function H(a){var b,c,d={};f.each(a,function(e, h){(b=e.match(/^([^A-Z]+?)([A-Z])/))&&-1!=="a aa ai ao as b fn i m o s ".indexOf(b[1]+" ")&&(c=e.replace(b[0],b[2].toLowerCase()),
