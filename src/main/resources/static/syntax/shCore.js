...
{
    // CommonJS
    SyntaxHighlighter = SyntaxHighlighter || (typeof require !== 'undefined'? require('src/main/webapp/WEB-INF/view/examples/resources/syntax/shCore').SyntaxHighlighter : null);
